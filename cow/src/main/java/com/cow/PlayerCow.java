...
public class PlayerCow extends Being {
    ...
    public void draw(Graphics2D g2) {
        ...
        if (heldItem != null && heldItem.getName().equals("Sword") && !direction.equals("down")) {
            ...
            // Adjust the sword's position based on the direction
            switch (direction) {
                case "left":
                    swordX = x - gp.tileSize / 3.25f; // Place sword to the left of the cow's head
                    swordY = y + gp.tileSize / 2f - gp.tileSize / 1.35f; // Center vertically
                    ...
                    break;
                case "right":
                    swordX = x + gp.tileSize - gp.tileSize / 4.25f; // Place sword to the right of the cow's head
                    swordY = y + gp.tileSize / 2f - gp.tileSize / 1.35f; // Center vertically
                    g2.drawImage(heldItem.getImage(), (int) swordX, (int) swordY, gp.tileSize, gp.tileSize, null);
                    break;
                case "up":
                    swordX = x + gp.tileSize / 2f - gp.tileSize / 8f; // Center horizontally
                    swordY = y - gp.tileSize / 4f; // Place sword above the cow's head
                    g2.drawImage(heldItem.getImage(), (int) swordX, (int) swordY, gp.tileSize, gp.tileSize, null);
                    break;
                default:
                    swordX = x + gp.tileSize / 2f - gp.tileSize / 4.5f; // Default to centered
        ...
        if (heldItem != null && heldItem.getName().equals("Sword") && direction.equals("down")) {
            float swordX = x + gp.tileSize / 2f - gp.tileSize / 16f; // Center horizontally
            float swordY = y + gp.tileSize - gp.tileSize / 1.3f; // Place sword in front of the cow's head
    
            // Save the current transformation
            AffineTransform oldTransform = g2.getTransform();
    
            // Rotate the graphics context by 15 degrees around the center of the sword
